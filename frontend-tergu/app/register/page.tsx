          ...
          <div className="flex min-h-screen items-center justify-center py-16 px-4">
            <Card className="w-full max-w-md shadow-xl bg-white/95 backdrop-blur-sm border-0 my-8">
              <CardHeader className="space-y-1">
                ...
                </div>                <CardTitle className="text-2xl font-bold text-center">Create an account</CardTitle>
                <CardDescription className="text-center">Enter your information to create a Tergucamperarea account</CardDescription>
              </CardHeader>
              {success ? (
