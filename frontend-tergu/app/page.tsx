    ...
    <div className="flex min-h-screen flex-col">
      ...
      <header className="sticky top-0 z-40 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">            <Link href="/" className="flex items-center space-x-2">
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 bg-white md:hidden">
          <div className="container mx-auto p-4 flex flex-col h-full">
            <div className="flex justify-between items-center mb-6">              <Link href="/" className="flex items-center space-x-2">
                <div className="rounded-full bg-primary/10 p-1">
                  <div className="h-8 w-8 rounded-full bg-primary" />
                </div>
                <span className="font-display font-bold text-xl">Tergucamperarea</span>
      ...
      <main className="flex-1">        {/* Hero Section */}
        <section className="relative">          <div className="absolute inset-0 z-0">            <Image
              src="/home.jpg"
          ...
          </div>          <div className="container relative z-20 py-16 sm:py-24 md:py-32 lg:py-40 px-4 sm:px-6">
          ...
          <div className="container px-4 sm:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Our smart campsite management system offers everything you need to control and monitor your campsite
                remotely.
              </p>
            </div>
          ...
          <div className="container px-4 sm:px-6">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl mb-4 font-display">
                ...
                Getting started with Tergucamperarea is simple and straightforward.
              </p>
            </div>
          ...
          <div className="container px-4 sm:px-6">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl mb-4 font-display">
                ...
                Hear from campers who have transformed their camping experience with Tergucamperarea.
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">              <TestimonialCard
                name="Sarah Johnson"
                role="Weekend Camper"
        ...
        <section id="faq" className="py-16 md:py-24 bg-accent/30">
          <div className="container px-4 sm:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Find answers to common questions about our smart campsite management system.
              </p>
            </div>
              ...
              <Accordion type="single" collapsible className="w-full">
                ...
                >
                  <AccordionTrigger className="hover:no-underline px-2">
                    How does the campsite control system work?
                  </AccordionTrigger>
                  <AccordionContent className="px-2">
                    Our system uses IoT devices installed at each campsite to control electricity, water, and access
                    barriers. These devices connect to our cloud platform, allowing you to control them remotely through
                ...
                >
                  ...
                  <AccordionContent className="px-2">
                    After creating an account, you can book a campsite by selecting your desired dates and submitting a booking request. Once approved, you'll have full access to control your campsite's utilities remotely.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem
                  value="item-3"
                ...
                >
                  ...
                  <AccordionContent className="px-2">
                    The IoT devices at your campsite will continue to operate based on your last settings. Once your
                    connection is restored, you'll regain full control and any usage data will be synchronized.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem
                  value="item-4"
                  className="border rounded-lg p-2 mb-3 border-border/60 bg-background shadow-sm"
                >
                  <AccordionTrigger className="hover:no-underline px-2">Is my data secure?</AccordionTrigger>
                  <AccordionContent className="px-2">
                    Yes, we take security seriously. All data is encrypted both in transit and at rest. We use
                    industry-standard authentication protocols and regularly audit our systems for vulnerabilities.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem
                  value="item-5"
                  className="border rounded-lg p-2 mb-3 border-border/60 bg-background shadow-sm"
                >
                  <AccordionTrigger className="hover:no-underline px-2">Can I extend my booking?</AccordionTrigger>
                  <AccordionContent className="px-2">
                    Yes, you can request to extend your booking through your dashboard. Extension requests are subject to availability and approval.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
          ...
          <div className="container px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg mb-8 text-white/90">
                Join thousands of campers who are enjoying the convenience of smart campsite management.
              </p>
              <Link href="/register">
    ...
    <Card hover className="h-full hover-lift">
      <CardContent className="p-6">
        <div className="flex items-center mb-4">
          <div className="relative h-[50px] w-[50px] overflow-hidden rounded-full mr-4 flex-shrink-0">
            <Image 
              src={image || "/home.jpg"} 
              alt={`Photo of ${name}`} 
              width={50}
